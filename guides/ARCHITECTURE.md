...
- **Matches [Pythia](https://github.com/FoxyNinjaStudios/pythia)**, whose segmentation approach this tool reimplements — AGPL-3.0 keeps the derivative under the same copyleft
- **Network copyleft** — users who interact with a hosted instance can obtain the source
